...
for x in range(0, 128):
  ...
  # This ensures that it only continues when it finds one that works.
  while not bitNotCorrect:
    ...
    try:
      ...
      if amount_expected > amount_received:
        ...
        # Need to get rid of padding created from encrypting
        ...
        if message.upper() == decAnswer:
          ...
          if x == 127:
            # Ensure that it doesn't go one iteration past what it needs
            break
  ...
  # message = "'The 'Ouse of Lords,' put in the old man reminiscently."
  # AESKey = "00000100100111001011100111111110011010100011001011000111001100010100010010110000110000011111100001011111110010011010111000010101"